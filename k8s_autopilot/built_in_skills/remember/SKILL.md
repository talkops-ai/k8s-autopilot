...
**Global** (`~/.k8s_autopilot/AGENTS.md` or `~/.agents/AGENTS.md`): Universal preferences across all projects
**Project** (`.k8s_autopilot/AGENTS.md`, `AGENTS.md`, or `.agents/AGENTS.md`): Project-specific conventions and decisions
...
**Example:** If we discussed best practices for Kubernetes ingress routing, create an ingress-routing skill that encodes those practices into a reusable workflow.

### Skill Location
- **User skill**: `~/.k8s_autopilot/skills/<skill-name>/SKILL.md` or `~/.agents/skills/<skill-name>/SKILL.md`
- **Project skill**: `.k8s_autopilot/skills/<skill-name>/SKILL.md` or `.agents/skills/<skill-name>/SKILL.md`
