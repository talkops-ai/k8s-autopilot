...
1. **Run standalone**: ``python -m k8s_autopilot.core.integration.slack.app``
...
from k8s_autopilot.core.integration.slack.bolt_handlers import (
...
def create_slack_integration_server(
    ...
    bot_token = config.SLACK_BOT_TOKEN or "xoxb-dummy-token"
    ...
    async def lifespan(app: Starlette):  # noqa: ARG001
        ...
        try:
            from k8s_autopilot.core.hitl.checkpointer import close_async_pool  # noqa: PLC0415
            await close_async_pool()
        except Exception as exc:  # noqa: BLE001
            logger.warning(f"Pool cleanup error: {exc}")
