...
from k8s_autopilot.json_types import JSON_VALUE_ADAPTER, JsonObject, JsonValue
...
class AutopilotNotificationKind(StrEnum):
    """K8s Autopilot lifecycle notifications with compatible wire mappings."""
...
class AutopilotNotification(_DomainModel):
    """A notification emitted by a lifecycle owner."""
