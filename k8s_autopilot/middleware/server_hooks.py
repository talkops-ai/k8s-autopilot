"""LangGraph interrupt bridge for server-owned Hooks v2 events."""
...
from k8s_autopilot.hooks.tools import to_wire_tool_name
...
@register_middleware(name="server_hooks")
