...
| Modifying URLs (StripPrefix, ReplacePath, Redirects) | `traefik-reference/traefik-middlewares-routing.md` |
| Access Control (BasicAuth, IP Whitelisting, RateLimit) | `traefik-reference/traefik-middlewares-security.md` |
| Reliability (Retry, CircuitBreaker, Buffering) | `traefik-reference/traefik-middlewares-resilience.md` |
| Canary, Mirroring, or Failover | `traefik-reference/traefik-advanced-services.md` |
| Database, MQTT, or raw TCP/UDP exposition | `traefik-reference/traefik-tcp-udp.md` |
